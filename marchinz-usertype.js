"use strict";
/* ============ ユーザータイプ(だれ向けの画面にするか) ============
   ①ファン／保護者 ②プレイヤー／団体 ③スタッフ／クリエイター の3つ。
   1つの枠で2つの立場を受けとめる: 応援する人と見守る保護者、演奏する人と
   団体そのもの、撮る人と運営する人。細かく分けるほど「自分はどれ?」で
   止まってしまうため(2026-07-22 広報レビュー)。
...
window.MZUserType = (() => {
  ...
  const TYPES = Object.freeze({
    ...
    player: {
      ...
      label: "プレイヤー／団体",
      short: "プレイヤー",
      desc: "演奏する・活動する。練習の記録や仲間・団体のやりとりを中心に",
      icon: "fa-drum",
    },
    creator: {
      id: "creator",
      /* 「クリエイター」を先頭にすると撮影者の呼び名に見え、広報・運営の人が
         自分事にならなかった(2026-07-22 広報レビュー)。スタッフを先に置く */
      label: "スタッフ／クリエイター",
      short: "スタッフ",
